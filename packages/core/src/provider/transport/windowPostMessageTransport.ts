 ...
 *
 * 页面侧 Transport 实现，通过 window.postMessage 与 content script 通信
 */
import { EventEmitter } from "eventemitter3";
import { evmProviderErrors, evmRpcErrors } from "../errors";
import { CHANNEL } from "../protocol/channel";
import { type Envelope, isEnvelope, resolveProtocolVersion } from "../protocol/envelope";
import { PROTOCOL_VERSION } from "../protocol/version";
import type { EIP1193ProviderRpcError, RequestArguments } from "../types/eip1193";
import type {
	Transport,
	TransportMeta,
	TransportRequest,
...
import { cloneTransportMeta, isTransportMeta } from "../utils/transportMeta";
